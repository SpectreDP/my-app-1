...
import { upadateObjectInArray } from "../utils/object-helper";
const FOLLOW = 'FOLLOW';
...
const usersReducer = (state = initialState, action) => {
    switch (action.type) {
        case FOLLOW:
            return {
                ...state,
                users: upadateObjectInArray(state.users, action.userId, 'id', { followed: true })
            };

        case UNFOLLOW:
            return {
                ...state,
                users: upadateObjectInArray(state.users, action.userId, 'id', { followed: false })
            };
        case SET_USERS:
